...
// 당신이 근무 중인 연구소에서는 신형 연료를 이용한 차량을 연구중이다.
// 신형 연료는 반응성이 높아 특수 합금으로 만들어진 용기에 담아 보관해야 한다.
// 연구가 활발해짐에 따라 연구소에서는 새로운 연료 보관용 탱크를 제작하기로 했다.
// 회의 결과 새로운 보관탱크는 6개의 면이 모두 합금판으로 이루어진 직육면체 형태의 용기로 결정되었으며,
// 아래와 같은 제약사항을 만족하도록 설계하기로 했다.
//
...
//
// 설계 요구사항 M이 주어질 때, 필요한 최적의 합금한 면적을 구해보자.
//
// 제약조건
// 1 < M < 100000
// 1 ≤가로, 세로, 높이 ≤ 50
...
//
// 출력형식
// 첫 줄에 주어진 요구사항을 모두 만족하는 연료탱크의 가로, 세로, 높이 의 길이를 공백을 사이에 두고 출력한다.
//
// 입력예제1
// 100
//
